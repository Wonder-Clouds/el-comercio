...
from seller.validators import validate_is_number, validate_no_spaces
...
class Seller(TimeStampedModel):
    ...
    number_seller = models.CharField(max_length=20, unique=True, null=False, blank=False, validators=[validate_is_number, validate_no_spaces])
